...
export default function BirthDayCard({ name = "Maria Silva", brithDayDate = new Date() }: BirthDayCardProps) {
    ...
    <Card className="w-full max-w-md mx-auto shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-center space-x-2 text-muted-foreground">
          ...
          <span className="text-lg sm:text-base xl:text-base 2xl:text-lg">Próximo aniversário em:</span>
        </div>
